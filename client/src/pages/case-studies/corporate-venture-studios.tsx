...
import { ArrowRight, Calendar, Target, Zap, Share2, Linkedin, Instagram, MessageSquare, Link2, Send, Building2, Lightbulb } from "lucide-react";
...
export default function CorporateVentureStudiosCaseStudy() {
  ...
  const handleCommentSubmit = async (e: React.FormEvent) => {
    ...
    const success = await submit({ 
      ...
      caseStudy: "Corporate Venture Studios",
      ...commentForm 
    });
