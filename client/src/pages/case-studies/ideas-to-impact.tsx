...
import { ArrowRight, Calendar, Target, Zap, Share2, Linkedin, Instagram, MessageSquare, Link2, Send, Rocket, Globe, Users } from "lucide-react";
        ...
        <div className="container mx-auto px-6">
          ...
          >
            ...
            <h1 className="text-3xl md:text-5xl lg:text-6xl font-heading font-bold text-black mb-6 uppercase leading-tight">
              ...
              <span>Qatar's Path to a Thriving Ecosystem</span>
            </h1>
