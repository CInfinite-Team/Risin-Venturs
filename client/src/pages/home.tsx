...
import heroBg from "@/assets/hero-concepts/option3-minimal-v2.png";
          ...
          >
            ...
            <motion.div variants={fadeIn} className="flex flex-col sm:flex-row gap-5">
              <Link href="/build-with-us">
                <Button className="bg-white text-[#2b204c] hover:bg-[#952828] hover:text-white transition-all rounded-sm h-14 md:h-16 px-10 text-base md:text-lg font-bold uppercase tracking-widest shadow-xl border-0">
                  Build With Us
                </Button>
              </Link>
              <a href="#programs">
