...
import { ArrowRight, Linkedin, Facebook, Youtube, Instagram } from "lucide-react";
            ...
            <div className="flex gap-4">
              {[
                ...
                <a 
                  ...
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="w-10 h-10 border border-slate-200 rounded-sm flex items-center justify-center text-slate-400 hover:text-[#8b68f6] hover:border-[#8b68f6] transition-all bg-[#F9FAFB]"
                >
                  {social.icon}
                </a>
              ))}
