  ...
  return (
    <div className="min-h-screen bg-white font-sans">
          ...
          <div className="w-full h-[500px] bg-slate-100 rounded-sm relative overflow-hidden">
            <div className="absolute inset-0 flex items-center justify-center">
              <span className="text-slate-400 font-bold uppercase tracking-widest text-sm bg-white/50 px-4 py-2 rounded-sm backdrop-blur-sm border border-slate-200">
                Program image to be added: Main Summit Hall Atmosphere
              </span>
            </div>
          </div>
        </div>
             ...
             <div className="h-[400px] bg-slate-100 rounded-sm relative overflow-hidden">
                <div className="absolute inset-0 flex items-center justify-center">
                  <span className="text-slate-400 font-bold uppercase tracking-widest text-sm bg-white/50 px-4 py-2 rounded-sm backdrop-blur-sm border border-slate-200 text-center">
                    Program image to be added: <br/> Hackathon Teams Coding
                  </span>
                </div>
             </div>
             <div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {highlights.map((item, i) => (
              <motion.div 
                ...
                className="bg-white p-8 rounded-sm border border-slate-100 hover:shadow-lg hover:border-[#8b68f6]/30 transition-all group"
              >
      ...
      <section className="pb-16 bg-[#F9FAFB]">
        <div className="container mx-auto px-6">
          <div className="w-full h-[400px] bg-white border border-slate-100 rounded-sm relative overflow-hidden">
            <div className="absolute inset-0 flex items-center justify-center">
              <span className="text-slate-400 font-bold uppercase tracking-widest text-sm bg-slate-50 px-4 py-2 rounded-sm border border-slate-200">
                Program image to be added: Awards Ceremony & Winners
              </span>
            </div>
          </div>
        </div>
